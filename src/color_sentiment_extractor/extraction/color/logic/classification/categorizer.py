"""
categorizer.py
Does: Build strict modifier↔tone mappings from phrases (spaces/hyphens/glued), using strict base recovery for modifiers and filtering cosmetic nouns from tones.
...
def build_tone_modifier_mappings(
    ...
    """
    Does: Derive bidirectional mappings (modifier↔tone) using strict base recovery for modifiers; excludes cosmetic nouns as tones.
    Returns: (tones, modifiers, mod_to_tone, tone_to_mod).
    """
...
def format_tone_modifier_mappings(
    ...
    """
    Does: Convert mappings to sorted, JSON-ready dicts with stable keys/values.
